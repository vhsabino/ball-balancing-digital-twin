...
#define STEPPER4_DIR_PIN 11
#define STEPPER4_STEP_PIN 12
...
// NOTE: SineStepper and MoveBatch ids must be lower or equal than MAX_NUM_OF_STEPPERS
#define MAX_NUM_OF_STEPPERS 5
#define MAX_NUM_OF_MOVEBATCHES 100

// Max input size for the list of incoming instructions
#define INPUT_SIZE 4480
